  ...
  <v-container fluid>
    <v-card class="ma-3 pa-3">
      ...
      <v-card-text>
        <template>
          <div class="my-3">
            <div class="subheading text--lighten-2">Username</div>
          ...
          <v-form v-model="valid" ref="form" lazy-validation>
            ...
            <v-text-field
              ...
              required
            ></v-text-field>
            <div class="subheading text--lighten-2">
              User is superuser
...
export default class EditUser extends Vue {
  ...
  public async submit() {
    if (await this.$validator.validateAll()) {
      ...
      this.$router.push('/main/admin/users').catch(err => {
